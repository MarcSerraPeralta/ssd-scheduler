...
def measurement_circuit(rounds):
    ...
    for i in range(0,4):
        #noisy_stable_circuit.append('Z_ERROR', [int(i)],1*10**(-4))
        noisy_stable_circuit.append('MRX',[int(i)])
        noisy_stable_circuit.append('Z_ERROR', [int(i)],2/3*p)
    for j in range(13,17): 
        
        #noisy_stable_circuit.append('X_ERROR', [int(j)],1*10**(-4))
    ...
    #full_circuit.append('OBSERVABLE_INCLUDE', [stim.target_rec(-6),stim.target_rec(-5),stim.target_rec(-4)],0)
    #full_circuit.append('OBSERVABLE_INCLUDE', [stim.target_rec(-3),stim.target_rec(-2),stim.target_rec(-1)],0)
    
    full_circuit.append('OBSERVABLE_INCLUDE', [stim.target_rec(-9),stim.target_rec(-6),stim.target_rec(-3)],0)
    full_circuit.append('OBSERVABLE_INCLUDE', [stim.target_rec(-8),stim.target_rec(-5),stim.target_rec(-2)],1)
    full_circuit.append('OBSERVABLE_INCLUDE', [stim.target_rec(-7),stim.target_rec(-4),stim.target_rec(-1)],2)
    ...
    full_circuit.append('DETECTOR',[stim.target_rec(-8),stim.target_rec(-7),stim.target_rec(-17)])
    full_circuit.append('DETECTOR',[stim.target_rec(-9),stim.target_rec(-8),stim.target_rec(-6),stim.target_rec(-5),stim.target_rec(-16)])
    full_circuit.append('DETECTOR',[stim.target_rec(-5),stim.target_rec(-4),stim.target_rec(-2),stim.target_rec(-1),stim.target_rec(-15)])
    full_circuit.append('DETECTOR',[stim.target_rec(-3),stim.target_rec(-2),stim.target_rec(-14)])
    ...
    for j in range(13,17): 
        stable_circuit_2.append('MR',[int(j)])
...
for i in range(20):
    ...
    #full_circuit.append('OBSERVABLE_INCLUDE', [stim.target_rec(-7),stim.target_rec(-5),stim.target_rec(-3)],0)
    #full_circuit.append('OBSERVABLE_INCLUDE', [stim.target_rec(-9),stim.target_rec(-5),stim.target_rec(-1)],0)
