# -*- coding: utf-8 -*-
"""
Created on Thu Oct 24 15:03:49 2024
...
#B.add_nodes_from(['q_0','q_1','q_2','q_3','q_4','q_5','q_6'], bipartite=2)                 


#edges = [
#    ('Z1','q_1'), ('Z1','q_2'), ('Z1','q_3'), ('Z1','q_4'),
#    ('Z2','q_0'), ('Z2','q_1'), ('Z2','q_4'), ('Z2','q_5'),
#   ('Z3','q_0'), ('Z3','q_2'), ('Z3','q_3'), ('Z3','q_5'),

    
#    ('X1','q_0'), ('X1','q_2'), ('X1','q_4'),
#    ('X2','q_0'), ('X2','q_1'), ('X2','q_3'),
#    ('X3','q_1'), ('X3','q_2'), ('X3','q_5'),
#    ('X4','q_3'), ('X4','q_4'), ('X4','q_5')
#   ]



#Tetrahemihexahedron
B.add_nodes_from(['X1','X2','X3','X4','X5','X6'], bipartite=0)  
B.add_nodes_from(['Z1','Z2','Z3','Z4', 'Z5','Z6','Z7'], bipartite=1)
...
print(list(overlapping_neighbohrs))
